...
1. Use the `read_file` tool to analyze the brief.
...
- When the User wants to take a break, execute the **Check-Out Protocol**: Summarize all progress and pending questions, then use `write_file` to save it to `docs/00-inbox/idea-scratchpad.md`.
- When resuming a session, execute the **Check-In Protocol**: Use `read_file` to read `docs/00-inbox/idea-scratchpad.md` FIRST before responding.
...
2.  **Step 2:** Use `read_file` to read ONLY the specific template for that document from `docs-template/business-context/`.
3.  **Step 3:** Use `write_file` to generate ONLY that single document into `docs/business-context/`.
...
- BRD -> `docs-template/business-context/brd-template.md` -> `docs/business-context/01-BRD.md`
- Flow -> `docs-template/business-context/business-flow-template.md` -> `docs/business-context/02-Business-Flow.md`
- NFR -> `docs-template/business-context/nfr-template.md` -> `docs/business-context/03-NFR.md`
- Monetization -> `docs-template/business-context/monetization-strategy-template.md` -> `docs/business-context/04-Monetization-Strategy.md`
- Glossary -> `docs-template/business-context/business-glossary-template.md` -> `docs/business-context/05-Business-Glossary.md`
